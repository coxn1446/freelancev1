    ...
    reducers: {
        ...
        chooseHoroscope: (state) => {
            const horoscopes = [
                ...
                "Do not try yoga.",
                "Start sneezing into your hand. That 'into your elbow' myth is nonsense.",
                "Buy a new fine china set. You deserve this.",
                "You actually don't have a horoscope today. The stars have not aligned in a way that allows for interpretation. Try again tomorrow.",
                "Commit a petty crime today. You will thank me later.",
                "Have you ever thought about how ALL pigeons are adult sized? Where are the baby pigeons?",
                ...
                "Do something creative today! Build a mental prison for yourself to live in 24/7!",
